        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="mt-2 text-xs text-blue-700 space-y-1">
              <p><strong>Admin:</strong> john.doe@company.com</p>
              <p><strong>Project Manager:</strong> sarah.johnson@company.com</p>
              <p><strong>Team Member:</strong> mike.chen@company.com</p>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button variant="outline" className="w-full" onClick={() => alert('For this demo, please use the email/password login above. Try: john.doe@company.com with password "password"')}>
